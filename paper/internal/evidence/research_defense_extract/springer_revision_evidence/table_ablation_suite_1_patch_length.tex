...
\midrule
P=1 (Daily Token Baseline) & 1 & 252 & +0.85\% (3.82\%) & 0.082 (0.185) & 0.112 & -22.16\% \\
P=3 (Bi-daily Patching) & 3 & 84 & +2.12\% (4.15\%) & 0.174 (0.192) & 0.231 & -21.55\% \\
\textbf{P=6 (Weekly Macro-Patch, Champion)} & 6 & 42 & \textbf{+3.54\% (4.85\%)} & \textbf{0.271 (0.205)} & \textbf{0.356} & \textbf{-17.40\%} \\
P=12 (Bi-weekly Patching) & 12 & 21 & +2.68\% (4.32\%) & 0.215 (0.198) & 0.288 & -20.10\% \\
P=21 (Monthly Macro-Patching) & 21 & 12 & +1.45\% (3.94\%) & 0.118 (0.189) & 0.154 & -21.80\% \\
\bottomrule
\end{tabular}
